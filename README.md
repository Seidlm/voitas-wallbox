...
2. Add `https://github.com/Seidlm/Voitas-Wallbox-HA-Integration` → Category: **Integration**
3. Click **Download**
...
→ No UDP packet received for 30 seconds. Check network connectivity.
